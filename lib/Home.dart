...
class _HomeScreenState extends State<HomeScreen> {
    ...
    void initState() {
      ...
      // Initialize filteredChats with all chats // search functionality
      ...
      return Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(
              icon: SvgPicture.asset('assets/images/Call.svg', width: 24, height: 24),
              label: 'Calls',
            ),
            BottomNavigationBarItem(
              icon: SvgPicture.asset('assets/images/user.svg', width: 24, height: 24),
              label: 'Contacts',
            ),
            BottomNavigationBarItem(
              ...
              children: [
                ...
                if (showOverlay)
                  Positioned(
                    ...
                    child: CircleAvatar(
                      radius: 10,
                      backgroundImage: AssetImage('assets/images/Vector.svg'),
